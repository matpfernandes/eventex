...
class SubscribeTest(TestCase):
    ...
    def test_get(self):
        '''Get /inscrcao/ must return status code 200'''
...
class SubscribePostTest(TestCase):
    ...
    def test_subscription_email_body(self):
        ...
        self.assertIn('Matheus Fernandes', email.body)
        self.assertIn('12345678901', email.body)
        self.assertIn('matpfernandes@gmail.com', email.body)
        self.assertIn('14-99605-5972', email.body)
